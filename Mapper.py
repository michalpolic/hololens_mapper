...
class Mapper():
    ...
    def run(self, recoring_dir, uvdata_path, out_dir):
        ...
        colmap.extract_features(out_dir + "/colmap/database.db", recoring_dir + "/pv")
        colmap.exhaustive_matcher(out_dir + "/colmap/database.db")
        colmap.mapper(out_dir + "/colmap/database.db", recoring_dir + "/pv", out_dir + "/colmap/sparse")
        ...
        meshroom_io.save_colmap_to_json(out_dir_abs + "/sfm.json", recoring_dir + "/pv/", colmap_cameras, colmap_images, colmap_points)
        ...
        meshroom.meshing(sfm_abc_path, out_cache_dir + "/Meshing/test/densePointCloud.abc", out_cache_dir + "/Meshing/test/mesh.obj", out_cache_dir + "/DepthMapFilter/test")
        ...
        meshroom_io.save_merged_mvs_to_json(out_dir_abs + "/holo_and_mvs.json", recoring_dir_abs + "/pv/", colmap_cameras, colmap_images, common_xyz_fitered, visibility_map)
        ...
        meshroom.meshing(out_cache_dir + "/ConvertSfMFormat/test_merged/sfm.abc", out_cache_dir + "/Meshing/test_merged/densePointCloud.abc", out_cache_dir + "/Meshing/test_merged/mesh.obj")
