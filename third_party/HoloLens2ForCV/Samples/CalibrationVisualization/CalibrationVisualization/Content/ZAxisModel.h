...
namespace BasicHologram
{
    ...
    {
    public:
        ZAxisModel(std::shared_ptr<DX::DeviceResources> const& deviceResources, float length, float thick) :
    ...
    protected:
        ...
        void GetModelZAxisVertices(std::vector<VertexPositionColor> &modelVertices);
