...
void XAxisModel::GetModelXAxisVertices(std::vector<VertexPositionColor> &modelVertices)
{
    ...
    modelVertices.push_back({ XMFLOAT3(m_length, -(m_thick/2), -(m_thick/2)), m_endColor, XMFLOAT2(0.0f, 0.0f)});
    modelVertices.push_back({ XMFLOAT3(m_length, -(m_thick/2),  (m_thick/2)), m_endColor, XMFLOAT2(0.0f, 1.0f)});
    modelVertices.push_back({ XMFLOAT3(m_length,  (m_thick/2), -(m_thick/2)), m_endColor, XMFLOAT2(1.0f, 0.0f)});
    modelVertices.push_back({ XMFLOAT3(m_length,  (m_thick/2),  (m_thick/2)), m_endColor, XMFLOAT2(1.0f, 1.0f)});
}
