...
DirectX::XMMATRIX YAxisModel::GetModelRotation()
{
    return DirectX::XMMatrixIdentity();
    //return DirectX::XMMatrixRotationAxis(DirectX::XMVectorSet(0.f, 0.f, 1.f, 0.f), -DirectX::XM_PIDIV2);
}

void YAxisModel::GetModelVertices(std::vector<VertexPositionColor> &modelVertices)
{
    GetModelYAxisVertices(modelVertices);
}

void YAxisModel::GetModelYAxisVertices(std::vector<VertexPositionColor> &modelVertices)
{
    modelVertices.push_back({ XMFLOAT3(-(m_thick/2), 0.0f, -(m_thick/2)), m_originColor, XMFLOAT2(0.0f, 0.0f)});
    modelVertices.push_back({ XMFLOAT3(-(m_thick/2), 0.0f,  (m_thick/2)), m_originColor, XMFLOAT2(0.0f, 1.0f)});
    modelVertices.push_back({ XMFLOAT3(-(m_thick/2), m_length, -(m_thick/2)), m_endColor, XMFLOAT2(1.0f, 0.0f)});
    modelVertices.push_back({ XMFLOAT3(-(m_thick/2), m_length,  (m_thick/2)), m_endColor, XMFLOAT2(1.0f, 1.0f)});
    modelVertices.push_back({ XMFLOAT3((m_thick/2), 0.0f, -(m_thick/2)), m_originColor, XMFLOAT2(0.0f, 0.0f)});
    modelVertices.push_back({ XMFLOAT3((m_thick/2), 0.0f,  (m_thick/2)), m_originColor, XMFLOAT2(0.0f, 1.0f)});
    modelVertices.push_back({ XMFLOAT3((m_thick/2), m_length, -(m_thick/2)), m_endColor, XMFLOAT2(1.0f, 0.0f)});
    modelVertices.push_back({ XMFLOAT3((m_thick/2), m_length,  (m_thick/2)), m_endColor, XMFLOAT2(1.0f, 1.0f)});
...
void YAxisModel::GetOriginCenterdCubeModelVertices(std::vector<VertexPositionColor> &modelVertices)
{
...
void YAxisModel::GetModelTriangleIndices(std::vector<unsigned short> &triangleIndices)
{
    /*
    2,1,0, // -x
    2,3,1,
