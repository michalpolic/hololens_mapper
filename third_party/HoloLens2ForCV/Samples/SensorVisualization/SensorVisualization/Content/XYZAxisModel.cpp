...
void XYZAxisModel::GetModelXAxisVertices(std::vector<VertexPositionColor> &modelVertices)
{
    ...
    modelVertices.push_back({ XMFLOAT3(m_lengthX, -(m_thick/2), -(m_thick/2)), m_xoriginColor, XMFLOAT2(0.0f, 0.0f)});
    modelVertices.push_back({ XMFLOAT3(m_lengthX, -(m_thick/2),  (m_thick/2)), m_xoriginColor, XMFLOAT2(0.0f, 1.0f)});
    modelVertices.push_back({ XMFLOAT3(m_lengthX,  (m_thick/2), -(m_thick/2)), m_xoriginColor, XMFLOAT2(1.0f, 0.0f)});
    modelVertices.push_back({ XMFLOAT3(m_lengthX,  (m_thick/2),  (m_thick/2)), m_xoriginColor, XMFLOAT2(1.0f, 1.0f)});
    ...
    modelVertices.push_back({ XMFLOAT3(-(m_thick/2), m_lengthY, -(m_thick/2)), m_yoriginColor, XMFLOAT2(1.0f, 0.0f)});
    modelVertices.push_back({ XMFLOAT3(-(m_thick/2), m_lengthY,  (m_thick/2)), m_yoriginColor, XMFLOAT2(1.0f, 1.0f)});
    modelVertices.push_back({ XMFLOAT3((m_thick/2), 0.0f, -(m_thick/2)), m_yoriginColor, XMFLOAT2(0.0f, 0.0f)});
    modelVertices.push_back({ XMFLOAT3((m_thick/2), 0.0f,  (m_thick/2)), m_yoriginColor, XMFLOAT2(0.0f, 1.0f)});
    modelVertices.push_back({ XMFLOAT3((m_thick/2), m_lengthY, -(m_thick/2)), m_yoriginColor, XMFLOAT2(1.0f, 0.0f)});
    modelVertices.push_back({ XMFLOAT3((m_thick/2), m_lengthY,  (m_thick/2)), m_yoriginColor, XMFLOAT2(1.0f, 1.0f)});
    ...
    modelVertices.push_back({ XMFLOAT3(-(m_thick/2), -(m_thick/2), m_lengthZ), m_zoriginColor, XMFLOAT2(0.0f, 1.0f)});
    modelVertices.push_back({ XMFLOAT3(-(m_thick/2),  (m_thick/2), 0.0f), m_zoriginColor, XMFLOAT2(1.0f, 0.0f)});
    modelVertices.push_back({ XMFLOAT3(-(m_thick/2),  (m_thick/2), m_lengthZ), m_zoriginColor, XMFLOAT2(1.0f, 1.0f)});
    modelVertices.push_back({ XMFLOAT3((m_thick/2), -(m_thick/2), 0.0f), m_zoriginColor, XMFLOAT2(0.0f, 0.0f)});
    modelVertices.push_back({ XMFLOAT3((m_thick/2), -(m_thick/2), m_lengthZ), m_zoriginColor, XMFLOAT2(0.0f, 1.0f)});
    modelVertices.push_back({ XMFLOAT3((m_thick/2),  (m_thick/2), 0.0f), m_zoriginColor, XMFLOAT2(1.0f, 0.0f)});
    modelVertices.push_back({ XMFLOAT3((m_thick/2),  (m_thick/2), m_lengthZ), m_zoriginColor, XMFLOAT2(1.0f, 1.0f)});
