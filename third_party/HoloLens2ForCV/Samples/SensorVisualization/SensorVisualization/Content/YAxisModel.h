...
namespace BasicHologram
{
    ...
    {
    public:
        YAxisModel(std::shared_ptr<DX::DeviceResources> const& deviceResources, float length, float thick) :
    ...
    protected:
        ...
        void GetModelYAxisVertices(std::vector<VertexPositionColor> &modelVertices);
