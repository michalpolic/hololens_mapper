    ...
    def processChunk(self, chunk):
        try:
            ...
            if matcher._matcher_name == "SIFT":
                ...
                colmap.extract_features("/colmap/database.db", "/pv", \
                    colmap_container._container_type == "docker")           # COLMAP feature extractor
                chunk.logger.info('COLMAP --> exhaustive matching')
                colmap.exhaustive_matcher("/colmap/database.db", \
                    colmap_container._container_type == "docker")           # COLMAP matcher
